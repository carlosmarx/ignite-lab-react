...
import { CaretRight, DiscordLogo, FileArrowDown, Image, Lightning, PictureInPicture } from "phosphor-react";
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img 
                ...
                src="https://avatars.githubusercontent.com/u/967220?v=4" 
                alt="Avatar" 
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Carlos Marx</strong>
                <span className="text-gray-200 text-sm block">Software Development</span>
              </div>
